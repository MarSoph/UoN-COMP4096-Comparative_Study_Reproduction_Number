...
#ggarrange(V013[[2]], V013[[1]],labels = c('a','b'), common.legend = FALSE)
#ggsave(file = "SimuData013.pdf", width = 7.30,height=3.5, units=c('in'))

v005=plot_simu_v_val(v_val=0.005, data=out0_005)
#ggarrange(V005[[2]], V005[[1]],labels = c('a','b'), common.legend = FALSE)
#ggsave(file = "SimuData005.pdf", width = 7.30,height=3.5, units=c('in'))
...
Rt_025=calc_Rt(v_value=0.025, data=out0_025)[[2]] #were not used!
...
```{r}
Rt=cbind(Rt013=read.csv('Rt_013.csv')[,1:2],
         Rt005=read.csv('Rt_005.csv')$Rt)

B=ggplot(as.data.frame(Rt), aes(x=Rt013.X, y=variables, color=variable))+
  geom_line(aes(y=Rt013.Rt, col='v=0.013',linetype='v=0.013'))+
  geom_line(aes(y=Rt005, col='v=0.005',linetype='v=0.005'))+
  scale_color_manual(values=c("Blue","Black"))+
  scale_linetype_manual(values = c(2,1))+
  labs(linetype='Vaccination rate')+
  xlab('Days')+
...
A=ggplot(simuInc,aes(x=S013.X))+
    geom_line(aes(y=S013.x, linetype='v=0.013', 
                  col='v=0.013'))+
    geom_line(aes(y=S005, linetype='v=0.005',
                  col='v=0.005'))+
    scale_color_manual(values=c("Blue","Black"))+
    scale_linetype_manual(values = c(2,1))+
    labs(linetype='Vaccination rate')+
