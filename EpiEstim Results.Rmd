...
values and the ones obtained by DE'
  ...
  Bias=mean(abs(Rt$Mean[3:l]-Rt$original[3:l])) #mean absolute bias between estimated and tru Rt
  RMSE=rmse(Rt$original[3:l],Rt$Mean[3:l]) #RMSE between estimated and tru Rt
