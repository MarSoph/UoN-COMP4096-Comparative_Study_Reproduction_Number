...
D=127/888000
N=888000/888000
y=c(S=N-E-P-I-J-A-Tv-V-Ev-Pv-Iv-Jv-Av-R-D, E=E, P=P, I=I,J=J, A=A, Tv=Tv, V=V, Ev=Ev, Pv=Pv, Iv=Iv, Jv=Jv, Av=Av, R=R, D=D)
...
print(matplot.0D(out0_013,legend=list(x='topright',cex=0.6)))#, which=c('E','P','I','A','R','Ev','Pv','Iv','Av')))
```
```{r}
#out$I + (rpois(151,0.46)/888000)
plot_simu_v_val=function(v_val, data){
  gg1=ggplot(data,aes(x=time,y=variables,color=variable))+ labs(color='Compartments') +
...
print(matplot.0D(out0_005,legend=list(x='topright',cex=0.6)))#, which=c('E','P','I','A','R','Ev','Pv','Iv','Av')))
...
print(matplot.0D(out0_025,legend=list(x='topright',cex=0.6)))#, which=c('E','P','I','A','R','Ev','Pv','Iv','Av')))

plot_simu_v_val(v_val=0.025, data=out0_025)
```
...
FJ=0
FA=0
#FEv=quote((1-ro[t+1])*b1*V*(I+d*A)+
            #(1-ro[t+1])*b2*V*(Iv+d*Av)+V*(b5*J+b6*Jv+b3*P+b4*Pv))
...
```{r}
Rt_005=calc_Rt(v_value=0.005, data=out0_005)[[2]]
Rt_013=calc_Rt(v_value=0.013,data=out0_013)[[2]]
Rt_025=calc_Rt(v_value=0.025, data=out0_025)[[2]]

Rt=cbind(t=seq(1,151),v0_005=Rt_005$Rt,v0_013=Rt_013$Rt,v0_025=Rt_025$Rt)

ggplot(as.data.frame(Rt), aes(x=t, y=variables, color=variable)) + labs(color='Vaccination rate')+geom_line(aes(y=v0_013, col='v=0.013'))+
  geom_line(aes(y=v0_005, col='v=0.005'))+
  geom_line(aes(y=v0_025, col='v=0.025'))+xlab('Days')+ggtitle('The time-varying R for three different vaccination rates') +geom_vline(xintercept = 29, col=1)+theme(legend.key.size = unit(5, 'mm'), plot.title = element_text(size = unit(11,'cm')),
        axis.text = element_text(size = unit(8,'cm')),
        axis.title = element_text(size = unit(11,'cm')),
        legend.text = element_text(size = unit(9, 'mm')),
        legend.title =element_text(size = unit(9, 'mm')),
...
ggplot(as.data.frame(R0), aes(x=t, y=variables, color=variable)) + labs(color='Vaccination rate')+geom_line(aes(y=v0_013, col='v=0.013'))+
  geom_line(aes(y=v0_005, col='v=0.005'))+
  geom_line(aes(y=v0_025, col='v=0.025'))+xlab('Days')+ggtitle('The basic reproduction number for three different vaccination rates')+geom_vline(xintercept = 29, col=1)+theme(legend.key.size = unit(5, 'mm'), plot.title = element_text(size = unit(11,'cm')),
        axis.text = element_text(size = unit(8,'cm')),
        axis.title = element_text(size = unit(11,'cm')),
        legend.text = element_text(size = unit(9, 'mm')),
        legend.title =element_text(size = unit(9, 'mm')),
...
ggplot(data.frame(t=seq(1,151),y=ro[1:151]),aes(x=t, y=y))+geom_line()+ylab(expression(~rho))+xlab('Number of days since 01/01/2021') +ggtitle(expression('Plot of the parameter'~ rho))+theme(legend.key.size = unit(5, 'mm'), plot.title = element_text(size = unit(11,'cm')),
        axis.text = element_text(size = unit(8,'cm')),
        axis.title = element_text(size = unit(11,'cm')),
        legend.text = element_text(size = unit(9, 'mm')),
        legend.title =element_text(size = unit(9, 'mm')),
